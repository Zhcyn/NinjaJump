...
class GameplayScene: SKScene,SKPhysicsContactDelegate  {
    ...
    var bg1 : BGNinjaClass?
    var bg2 : BGNinjaClass?
    var bg3 : BGNinjaClass?
    var Player : PlayerNinja?
    var canMove = false
    var moveLeft = false
    var center : CGFloat?
...
//        self.view?.addGestureRecognizer(swipeRightRec)
    ...
    func initializeVeriable(){
        ...
        Player = childNode(withName: "Player") as? PlayerNinja
    ...
    func getBackground(){
       bg1 = self.childNode(withName: "BG 1") as! BGNinjaClass?
       bg2 = self.childNode(withName: "BG 2") as! BGNinjaClass?
       bg3 = self.childNode(withName: "BG 3") as! BGNinjaClass?
        bg1?.name = "BG 1"
        bg2?.name = "BG 2"
        bg3?.name = "BG 3"
...
//        let shareBtn = SKSpriteNode(imageNamed: "Share")
  ...
  @objc func spownKunai(){
    ...
    func share(){
        let message = ("My Score on Ninja game is : "+String(GamePlayController.instace.score!)+" Download From Here : itms-apps://itunes.apple.com/app/id1510280752 ")
